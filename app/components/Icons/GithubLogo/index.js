  ...
  return (
    <svg x="0px" y="0px" width="50px" height="50px" viewBox="0 0 48 48">
      ...
      <g>
        ...
        <path fill="#ffffff" d="M20.106,35.863c0,0-2.349,0-2.79,0c-1.22,0-2.3-0.534-2.823-1.505c-0.587-1.079-1.14-2.3-2.585-3.309   c-0.255-0.179-0.108-0.438,0.393-0.38c0.489,0.051,1.416,0.159,2.126,1.088c0.708,0.93,1.481,1.997,2.81,1.997    c1.316,0,2.747,0.035,3.468-0.918L20.106,35.863z"></path>
      </g>
      <path fill="#ffffff" d="M24,5C13.504,5,5,13.504,5,24s8.504,19,19,19s19-8.504,19-19S34.496,5,24,5z M24,40.033  c-8.838,0-16.033-7.195-16.033-16.033S15.162,7.967,24,7.967S40.033,15.162,40.033,24S32.838,40.033,24,40.033z"></path>
    </svg>
  )
}

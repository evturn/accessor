    ...
    <div className={css.root}>
      <div className={css.wrap}>
        <div className={`${css.options} ${open ? css.on : css.off}`}>
          <ul className={css.ul}>
            <li onClick={selectOption('upload')} className={css.attach}>
              <AttachFileIcon className={css.icon} />
            </li>
            <li onClick={selectOption('write')} className={css.note}>
              <NoteIcon className={css.icon} />
            </li>
            <li onClick={selectOption('link')} className={css.link}>
              <LinkIcon className={css.icon} />
            </li>
          </ul>
        </div>
        <div onClick={toggleOptions} className={css.add}>
